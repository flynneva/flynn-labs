...
function About () {
  ...
  return (
    <div>
      ...
      <p>A perfect Sunday for me starts off with a morning hike or run, something delicious for breakfast with a hot cup of coffee, followed up with a few hours spent at a local coffee spot working on some software or a personal projec around the house.</p>
