          ...
          <Grid item xs={10}>
            <Card className={classes.card}>
              <CardContent justify='left' className={classes.cardContent}>
                <h2>About</h2>
                <p>Thanks for taking the time out of your day to read a little bit about what Flynn Labs is. Flynn Labs is just a collection of things that interest me and is definetly just a hobby project so please go easy on any issues/bugs you find.</p>
